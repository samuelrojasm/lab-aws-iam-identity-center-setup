...
> [!IMPORTANT]
> - **SAML nunca desaparece** - siempre es el mecanismo de autenticación real.<br>
> - **OAuth Device Flow** solo resuelve el problema de "¿cómo autorizo un dispositivo sin navegador?" pero la autenticación del usuario sigue siendo SAML<br>
